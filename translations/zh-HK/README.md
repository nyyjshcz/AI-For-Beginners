...
探索 **人工智能** (AI) 的世界，透過我們為期 12 星期、24 課的課程！內容包括實作課程、測驗和實驗室。課程適合初學者，涵蓋 TensorFlow 及 PyTorch 等工具，以及人工智能倫理。
...
[阿拉伯語](../ar/README.md) | [孟加拉語](../bn/README.md) | [保加利亞語](../bg/README.md) | [緬甸語](../my/README.md) | [中文（簡體）](../zh-CN/README.md) | [中文（繁體，香港）](./README.md) | [中文（繁體，澳門）](../zh-MO/README.md) | [中文（繁體，臺灣）](../zh-TW/README.md) | [克羅地亞語](../hr/README.md) | [捷克語](../cs/README.md) | [丹麥語](../da/README.md) | [荷蘭語](../nl/README.md) | [愛沙尼亞語](../et/README.md) | [芬蘭語](../fi/README.md) | [法語](../fr/README.md) | [德語](../de/README.md) | [希臘語](../el/README.md) | [希伯來語](../he/README.md) | [印地語](../hi/README.md) | [匈牙利語](../hu/README.md) | [印尼語](../id/README.md) | [意大利語](../it/README.md) | [日語](../ja/README.md) | [坎納達語](../kn/README.md) | [韓語](../ko/README.md) | [立陶宛語](../lt/README.md) | [馬來語](../ms/README.md) | [馬拉雅拉姆語](../ml/README.md) | [馬拉地語](../mr/README.md) | [尼泊爾語](../ne/README.md) | [尼日利亞皮欽語](../pcm/README.md) | [挪威語](../no/README.md) | [波斯語（法爾西語）](../fa/README.md) | [波蘭語](../pl/README.md) | [巴西葡萄牙語](../pt-BR/README.md) | [葡萄牙語（葡萄牙）](../pt-PT/README.md) | [旁遮普語（古魯穆奇）](../pa/README.md) | [羅馬尼亞語](../ro/README.md) | [俄語](../ru/README.md) | [塞爾維亞語（西里爾字母）](../sr/README.md) | [斯洛伐克語](../sk/README.md) | [斯洛維尼亞語](../sl/README.md) | [西班牙語](../es/README.md) | [斯瓦希里語](../sw/README.md) | [瑞典語](../sv/README.md) | [他加祿語（菲律賓語）](../tl/README.md) | [泰米爾語](../ta/README.md) | [泰盧固語](../te/README.md) | [泰語](../th/README.md) | [土耳其語](../tr/README.md) | [烏克蘭語](../uk/README.md) | [烏爾都語](../ur/README.md) | [越南語](../vi/README.md)

> **偏好本地克隆？**

> 此存儲庫包含 50 多種語言的翻譯，下載大小因此大增。若想跳過翻譯文件，請使用稀疏檢出：
> ```bash
...
**如果你希望支援其他翻譯語言，請參考 [這裡](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md) 的列表。**
...
* 不同的人工智能方法，包括「經典」符號法，如 **知識表示** 及推理 ([GOFAI](https://en.wikipedia.org/wiki/Symbolic_artificial_intelligence))。
* 位於現代 AI 核心的 **神經網絡** 和 **深度學習** 理論。我們會用兩個最熱門的框架——[TensorFlow](http://Tensorflow.org) 和 [PyTorch](http://pytorch.org) 的程式碼來說明這些重要主題的概念。
* 處理影像及文字的 **神經結構（Neural Architectures）**。將涵蓋最新模型，但可能不完全達到最新尖端水平。
* 較少流行的 AI 方法，例如 **遺傳算法** 和 **多代理系統**。

本課程不包含：

> [請參閱我們 Microsoft Learn 系列內本課程的所有附加資源](https://learn.microsoft.com/en-us/collections/7w28iy2xrqzdj0?WT.mc_id=academic-77998-bethanycheum)

* **商業領域中的 AI** 實務案例。建議參考 Microsoft Learn 裡的 [商業用戶 AI 入門課程](https://docs.microsoft.com/learn/paths/introduction-ai-for-business-users/?WT.mc_id=academic-77998-bethanycheum) 或與 [INSEAD](https://www.insead.edu/) 合作開發的 [AI 商業學校](https://www.microsoft.com/ai/ai-business-school/?WT.mc_id=academic-77998-bethanycheum)。
* 我們[機器學習初學者課程](http://github.com/Microsoft/ML-for-Beginners)中詳細描述的 **經典機器學習**。
* 利用 **[認知服務](https://azure.microsoft.com/services/cognitive-services/?WT.mc_id=academic-77998-bethanycheum)** 建置的實務 AI 應用。推薦從 Microsoft Learn 的 [視覺](https://docs.microsoft.com/learn/paths/create-computer-vision-solutions-azure-cognitive-services/?WT.mc_id=academic-77998-bethanycheum)、[自然語言處理](https://docs.microsoft.com/learn/paths/explore-natural-language-processing/?WT.mc_id=academic-77998-bethanycheum)、**[Azure OpenAI 服務的生成式 AI](https://learn.microsoft.com/en-us/training/paths/develop-ai-solutions-azure-openai/?WT.mc_id=academic-77998-bethanycheum)** 等模組開始。
* 特定的機器學習 **雲端框架**，例如 [Azure Machine Learning](https://azure.microsoft.com/services/machine-learning/?WT.mc_id=academic-77998-bethanycheum)、[Microsoft Fabric](https://learn.microsoft.com/en-us/training/paths/get-started-fabric/?WT.mc_id=academic-77998-bethanycheum) 或 [Azure Databricks](https://docs.microsoft.com/learn/paths/data-engineer-azure-databricks?WT.mc_id=academic-77998-bethanycheum)。建議參考 Microsoft Learn 的學習路徑 [使用 Azure Machine Learning 建置與運營機器學習解決方案](https://docs.microsoft.com/learn/paths/build-ai-solutions-with-azure-ml-service/?WT.mc_id=academic-77998-bethanycheum) 與 [使用 Azure Databricks 建置與運營機器學習解決方案](https://docs.microsoft.com/learn/paths/build-operate-machine-learning-solutions-azure-databricks/?WT.mc_id=academic-77998-bethanycheum)。
* **會話式 AI** 和 **聊天機器人**。有專門的 [建立會話式 AI 解決方案](https://docs.microsoft.com/learn/paths/create-conversational-ai-solutions/?WT.mc_id=academic-77998-bethanycheum) 學習路徑，並可參考本文：[這篇部落格](https://soshnikov.com/azure/hello-bot-conversational-ai-on-microsoft-platform/) 獲取更詳細資訊。
* 深入的深度學習數學理論。推薦參考 Ian Goodfellow、Yoshua Bengio 和 Aaron Courville 合著的 [深度學習](https://www.amazon.com/Deep-Learning-Adaptive-Computation-Machine/dp/0262035618)，也可線上閲讀 [https://www.deeplearningbook.org/](https://www.deeplearningbook.org/)。

如欲漸進式接觸 _雲端 AI_，建議參考 [Azure 人工智能入門](https://docs.microsoft.com/learn/paths/get-started-with-artificial-intelligence-on-azure/?WT.mc_id=academic-77998-bethanycheum) 學習路徑。
...
| 10  |            [生成對抗網絡及藝術風格轉換](./lessons/4-ComputerVision/10-GANs/README.md)             |           [PyTorch](./lessons/4-ComputerVision/10-GANs/GANPyTorch.ipynb) / [TensorFlow](./lessons/4-ComputerVision/10-GANs/GANTF.ipynb)             |  |
...
* 預習材料
* 可執行的 Jupyter 筆記本，通常特定於框架（**PyTorch** 或 **TensorFlow**）。可執行筆記本亦包含大量理論內容，因此要理解主題，需至少瀏覽其中一個版本的筆記本（PyTorch 或 TensorFlow）。
* 部分主題提供 **實驗室**，讓你有機會嘗試將所學應用於具體問題。
* 有些章節包含指向涵蓋相關主題的 [**MS Learn**](https://learn.microsoft.com/en-us/collections/7w28iy2xrqzdj0?WT.mc_id=academic-77998-bethanycheum) 模組的鏈接。

## 開始入門

### 🎯 AI 新手？從這裡開始！

如果你是 AI 新手，想快速嘗試動手例子，請查看我們的 [**初學者友好範例**](./examples/README.md)！這些包括：
...
- 我們已建立一個[設置課程](./lessons/0-course-setup/setup.md)，幫助你設置開發環境。- 對於教育工作者，我們也建立了一個[課程設置課程](./lessons/0-course-setup/for-teachers.md)給你！
- 如何在 VSCode 或 Codespace 中[執行程式碼](./lessons/0-course-setup/how-to-run.md)

請遵循以下步驟：

派生儲存庫：點擊本頁右上角的「Fork」按鈕。
...
加入我們的[官方 AI Discord 伺服器](https://aka.ms/genai-discord?WT.mc_id=academic-105485-bethanycheum)，與其他正在學習本課程的學員交流和建立網絡，並獲得支援。

如果你在開發過程中有產品意見或問題，請訪問我們的[Azure AI Foundry 開發論壇](https://aka.ms/foundry/forum)

## 小測驗

> **關於小測驗的說明**：所有小測驗均包含在 etc\quiz-app 下的 Quiz-app 資料夾中，或可在[此處線上查看](https://ff-quizzes.netlify.app/)。這些小測驗與課程中的內容鏈接，小測驗應用程式可本地運行或部署到 Azure；請遵照 `quiz-app` 資料夾中的指示操作。小測驗正逐步本地化。

## 尋求協助

你有建議或發現拼寫或程式碼錯誤嗎？請提出問題或建立 pull request。
...
如果你卡住了或有任何關於建立 AI 應用程式的問題，加入學員和有經驗開發者的討論 MCP 社群。這是一個支持性的社群，歡迎提問並自由分享知識。
...
**免責聲明**：  
本文件由 AI 翻譯服務 [Co-op Translator](https://github.com/Azure/co-op-translator) 翻譯。雖然我們致力於確保準確性，但請注意自動翻譯可能包含錯誤或不準確之處。原文文件應視為權威版本。對於重要資訊，建議尋求專業人類翻譯。我們不對因使用本翻譯而產生的任何誤解或誤釋承擔責任。
